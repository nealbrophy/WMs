...
awful.screen.connect_for_each_screen(function(s)
    ...
    beautiful.taglist_bg_focus = "#1d5b85"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"  }, "s",  function () awful.spawn("/usr/bin/io.elementary.shortcut-overlay") end,
              {description="show help", group="awesome"}),
    ...
    awful.key({                   }, "Print", function () awful.spawn.with_shell("sleep 0.1 && /usr/bin/io.elementary.screenshot-tool")   end,
              {description = "launch screenshot tool", group = "screenshot"}),
    awful.key({"Control"          }, "Print", function () awful.spawn.with_shell("sleep 0.1 && /usr/bin/io.elementary.screenshot-tool -w")   end,
              {description = "capture a screenshot of active window", group = "screenshot"}),
    awful.key({"Shift"            }, "Print", function () awful.spawn.with_shell("sleep 0.1 && /usr/bin/io.elementary.screenshot-tool -r")   end,
