...
awful.util.tagnames = {  "𝟙", "𝟚", "𝟛", "𝟜", "𝟝", "𝟞", "𝟟", "𝟠", "𝟡", "𝟘" }
-- awful.util.tagnames = {  "𝟏", "𝟐", "𝟑", "𝟒", "𝟓", "𝟔", "𝟕", "𝟖", "𝟗", "𝟎" }
-- awful.util.tagnames = {  "1️⃣ ", "2️⃣ ", "3️⃣ ", "4️⃣ ", "5️⃣ ", "6️⃣ ", "7️⃣ ", "8️⃣ ", "9️⃣ ", "0️⃣ " }
-- awful.util.tagnames = {  "♳", "♴", "♵", "♶", "♷", "♸", "♹" }
-- awful.util.tagnames = {  "𐒃", "𝟸", "ʒ", "Ч", "𝟻", "𝟨", "𐒇", "𐌚", "𐒘", "𐒠" }
-- awful.util.tagnames = {  "𝟭", "𝟮", "𝟯", "𝟰", "𝟱", "𝟲", "𝟳", "𝟴", "𝟵", "𝟬" }
-- awful.util.tagnames = {  "𝓐", "𝓑", "𝓒", "𝓓", "𝓔", "𝓕", "𝓖", "𝓗", "𝓘", "𝓙" }
-- awful.util.tagnames = {  "𝟷", "𝟸", "𝟹", "𝟺", "𝟻", "𝟼", "𝟽", "𝟾", "𝟿", "𝟶" }
-- awful.util.tagnames = {  "⓵", "⓶", "⓷", "⓸", "⓹", "⓺", "⓻", "⓼", "⓽", "⓾" }
-- awful.util.tagnames = {  "𝖨", "Ⅱ", "Ⅲ", "Ⅳ", "𝖵", "Ⅵ", "Ⅶ", "Ⅷ", "Ⅸ", "𝖷" }
-- awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒", "➓" }
--awful.util.tagnames = { "⠐", "⠡", "⠲", "⠵", "⠻", "⠿" }
...
globalkeys = my_table.join(
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey, "Shift"   }, "Left", function () awful.client.swap.global_bydirection("left")    end,
              {description = "swap with left client by index", group = "client"}),
    awful.key({ modkey, "Shift"   }, "k", function () awful.client.swap.byidx( -1)    end,
              {description = "swap with previous client by index", group = "client"}),
    awful.key({ modkey, "Shift"   }, "Right", function () awful.client.swap.global_bydirection("right")  end,
              {description = "swap with right client by index", group = "client"}),
