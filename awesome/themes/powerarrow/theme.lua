...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --]]
            -- using separators
            arrow(theme.bg_normal, "#C0C0A2"),
            wibox.container.background(wibox.container.margin(wibox.widget { mailicon, theme.mail and theme.mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#C0C0A2"),
            arrow("#C0C0A2", "#CB755B"),
            wibox.container.background(wibox.container.margin(wibox.widget { clock, theme.widget_clock, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), "#CB755B"),
