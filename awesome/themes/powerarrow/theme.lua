...
theme.bg_focus                                  = "#CB755B"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#2ec1e6"
theme.taglist_bg_focus                          = "#5e5d5d"
theme.tasklist_bg_focus                         = "#222222"
theme.tasklist_fg_focus                         = "#2ec1e6"
theme.border_width                              = dpi(2)
theme.border_normal                             = "#3F3F3F"
theme.border_focus                              = "#CB755B"
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { mailicon, theme.mail and theme.mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#8DAA9A"),
            arrow("#8DAA9A", "#C0C0A2"),
            wibox.container.background(wibox.container.margin(wibox.widget { clock, theme.widget_clock, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), "#C0C0A2"),
            ...
            arrow("#C0C0A2", "#777E76"),
            -- wibox.container.background(wibox.container.margin(textclock.widget, dpi(4), dpi(8)), "#777E76"),
            -- arrow("#777E76", "alpha"),
            --]]
            s.mylayoutbox,
        },
