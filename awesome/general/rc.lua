...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, "Control" }, "v", function () awful.spawn("vivaldi") end,
              {description = "open vivaldi", group = "launcher"}),
    awful.key({ altkey, "Control" }, "c", function () awful.spawn("code") end,
              {description = "open vscode", group = "launcher"}),
    awful.key({ altkey, "Control" }, "s", function () awful.spawn("flatpak run com.sublimetext.three") end,
              {description = "open sublime text", group = "launcher"}),
    awful.key({ altkey, "Control" }, "k", function () awful.spawn("flatpak run com.axosoft.GitKraken") end,
              {description = "open gitkraken", group = "launcher"}),
    ...
    awful.key({ altkey, "Shift" }, "y", function () awful.spawn("flatpak run com.jetbrains.PyCharm-Community") end,
              {description = "open pycharm-community", group = "launcher"}),
    awful.key({ altkey, "Control" }, "f", function () awful.spawn("firefox") end,
    ...
    awful.key({ altkey, "Control" }, "b", function () awful.spawn("flatpak run com.bitwarden.desktop") end,
